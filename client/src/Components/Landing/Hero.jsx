	...
	return(
		<div className="flex flex-col min-h-screen bg-blue-200 md:flex-row">
			<div className="flex flex-col justify-center md:ml-24 lg:m-2">
				...
				<h1 className="px-0 m-4 text-4xl md:px-24">Creater must click landing page</h1>
				<p className="p-4 px-0 sm:mr-10 md:px-24">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores fugit quisquam pariatur explicabo laborum iusto voluptatum inventore modi dolores! Non dicta blanditiis molestias minima voluptate?</p>
				<div className="px-24">
